...
from teneva import maxvol_rect
...
def nr(tensor):
    n, r = [], [1]
    for term in tensor:
        n.append(term.shape[1])
        r.append(term.shape[2])
    return np.asanyarray(n), np.asanyarray(r)
